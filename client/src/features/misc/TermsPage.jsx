  ...
  return (
    <PageShell width="narrow">
      ...
      <div className={styles.prose}>
        <h2>The service</h2>
        <p>
          Tourney (tourneylb.com) is a tool for organizing and tracking tournaments. It lets a host
          create a bracket or battle-royale tournament, take sign-ups from players or teams, run
        ...
        <p>
          ...
          and tell us at <ContactEmail /> if you think someone else has access to it.
        </p>

        <h2>Hosting subscription</h2>
        <p>
          Hosting more than the free plan&rsquo;s live tournaments requires a $5/month subscription,
          billed by Paddle as merchant of record. See the <a href="/refunds">refunds page</a> for
